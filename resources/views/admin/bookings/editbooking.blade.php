                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="tabs-eg-77">
                                            <form method="POST"
                                                action="{{ route('admin.update.booking', ['id' => $booking->id]) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="route_type" class="form-control">
                                                        ...
                                                        <option {{ $booking->route_type == 2 ? 'selected' : '' }}
                                                            value="2">Location</option>
                                                        <option {{ $booking->route_type == 1 ? 'selected' : '' }}
                                                            value="1">Round Trip</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="car_id" class="form-control">
                                                        @foreach ($cars as $car)
                                                            <option {{ $booking->car_id == $car->id ? 'selected' : '' }}
                                                                value="{{ $car->id }}">{{ $car->car_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select name="hourly_package_id" class="form-control">
                                                        @foreach ($hourly_package as $hourly)
                                                            <option
                                                                {{ $booking->hourly_package_id == $hourly->id ? 'selected' : '' }}
                                                                value="{{ $hourly->id }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="start_address"
                                                        value="{{ $booking->start_address }}" class="form-control"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label>To Location</label>
                                                    <input type="text" name="end_address"
                                                        value="{{ $booking->end_address }}" class="form-control"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Max Capacity Luggage</label>
                                                    <input type="number" min="1" name="luggage_count"
                                                        value="{{ $booking->luggage_count }}" class="form-control"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Max Capacity Luggage</label>
                                                    <input type="number" min="1" name="person_count"
                                                        value="{{ $booking->person_count }}" class="form-control"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Total Price</label>
                                                    <input type="number" min="1" name="total_price"
                                                        value="{{ $booking->total_price }}" class="form-control"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Status</label>
                                                    <select name="status" class="form-control">
                                                        ...
                                                        <option {{ $booking->status == 'unpaid' ? 'selected' : '' }}
                                                            value="unpaid">Unpaid</option>
                                                        <option {{ $booking->status == 'paid' ? 'selected' : '' }}
