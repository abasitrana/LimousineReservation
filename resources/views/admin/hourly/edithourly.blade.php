                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="tabs-eg-77">
                                            <form method="POST"
                                                action="{{ url('admin/updatehourly', $hourlyPackage->id) }}">
                                                @csrf
                                                <div class="form-group">
                                                    <label>Package Name</label>
                                                    <input type="text" name="package_name"
                                                        value="{{ $hourlyPackage->package_name, old('package_name') }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Package Description</label>
                                                    <input type="text" name="package_description"
                                                        value="{{ $hourlyPackage->package_description, old('package_description') }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Car</label>
                                                    <select name="car_id" class="form-control">
                                                        @foreach ($cars as $car)
                                                            <option value="{{ $car->id }}"
                                                                {{ $car->id == $hourlyPackage->car_id ? 'selected' : '' }}>
                                                                {{ $car->car_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1"
                                                        value="{{ $hourlyPackage->default_hours ?? 3 }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1" name="hourly_rate"
                                                        value="{{ $hourlyPackage->hourly_rate, old('hourly_rate') }}"
                                                        class="form-control" required>
                                                </div>
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-eg-77">
                                            <form method="POST" action="{{ url('admin/addhourly') }}"
                                                ...
                                                <div id="inputFieldsContainer" class="form-group">
                                                    ...
                                                    @foreach ($hourlyPackageSlabs as $slab)
                                                        <div class="input-field">
                                                            <input type="text" class="form-control mb-2"
                                                                name="hourly_slaps[]" placeholder="Hourly Slabs"
                                                                value="{{ $slab->hourly_slap }}">
                                                            <input type="number" class="form-control"
                                                                name="extra_hourly_rate[]" placeholder="Hourly Price"
                                                                value="{{ $slab->extra_hourly_price }}">
                                                            <button
                                                                class="removeInputField btn btn-primary pull-right mt-3 mb-3">Remove</button>
                                                        </div>
                                                    @endforeach
                                                </div>

                                                <button type="button" id="addExtraHourlyInfo"
