                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="tabs-eg-77">
                                            <form method="POST" action="{{ url('admin/addcars') }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="car_category_id" class="form-control">
                                                        @foreach ($cars_categories as $category)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" name="car_base_fare"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Max Capacity Persons</label>
                                                    <input type="number" min="1" name="max_capacity"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Max Capacity Luggage</label>
                                                    <input type="number" min="0" name="max_luggage"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
