                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="tabs-eg-77">
                                            ...
                                            <form method="POST" action="{{ url('admin/addzone') }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{-- <textarea class="form-control" name="zone" id="zone" cols="30" rows="10" required></textarea> --}}
                                                    <input type="text" class="form-control" name="zone"
                                                        id="zone" required value="{{ old('zone') }}">
                                                </div>
