...
<html lang="en">
    <head>
        <title>Our Services | Limousine Reservation</title>
        <meta charset="utf-8" />
        ...
        <section class="services-list">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="img-box">
                            <img src="{{asset('assets/images//mix/services/1.jpg')}}" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text-box">
                            <div class="headingstyle1">
                                <h3 class="fs-64">Title goes here</h3>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="img-box">
                            <img src="{{asset('assets/images//mix/services/2.jpg')}}" />
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="img-box">
                            <img src="{{asset('assets/images//mix/services/3.jpg')}}" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text-box">
