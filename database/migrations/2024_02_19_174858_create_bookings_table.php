...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('bookings', function (Blueprint $table) {
            ...
            $table->string('start_address_zipcode');
            $table->string('end_address_zipcode');
            $table->string('start_address_lat');
            $table->string('start_address_lng');
            $table->string('end_address_lat');
            $table->string('end_address_lng');
